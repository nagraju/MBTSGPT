...
public class AttendancePageData extends RetrofitBuilder {
    ...
    public AttendancePageData(FragmentAttendanceBinding binding, NavController findNavController){
    ...
    public void getAttendancePageData() {
